...
export function RequestBodyTabs({
  ...
  return (
    <div className="overflow-hidden rounded-2xl border border-[#E8E8EC] bg-white">
      <div className="flex flex-wrap items-center justify-between gap-3 border-b border-[#F0F0F3] px-5 py-3">
